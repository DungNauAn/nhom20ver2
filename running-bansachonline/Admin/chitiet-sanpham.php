...
<body class="hold-transition skin-blue sidebar-mini">
  <div class="wrapper">
    ...
    <div class="content-wrapper">
      ...
      <?php
      require '../model/quanlysanpham_model.php';
      $quanlysanpham = new Quanlysanpham();
      //lay san pham theo id
      $id = $_GET["id"];
      $row = $quanlysanpham->chiTietSanPham($id);
            ...
            <div class="box box-info">
              ...
              <form class="form-horizontal">
                ...
                <div class="box-footer">
                  <a href="quanly-sanpham.php"><button type="button" name="cancel" class="btn btn-default">Cancel</button></a>
                </div><!-- /.box-footer -->
              </form>
            </div><!-- /.box -->
