<?php
/* ---------------------------------- XỬ LÍ --------------------------------- */
require_once '../model/quanlysanpham_model.php';
...
if(isset($_POST['Edit'])) {
    ...
    $quanlysanpham->editProduct($id, $name, $hinhanh, $manhasx, $ngay, $gia, $khuyenmai, $giakhuyenmai, $tacgia, $mota);
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <select class="form-control select2" style="width: 100%;" name="manhasx">
                      ...
                      $results = $model->selectAll('nhaxuatban');
                      if ($results) {
